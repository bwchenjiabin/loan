<template>
    <div class="box">
       <div class="title"> 
           <i  @click="getdata()"><img src="../../../static/img/微信图片_20190528150040.png" alt=""></i><span class="my">帮助中心</span>
            <span class="geren">名词解释</span>
       </div>
       <div class="content">
           <!-- <ul v-for="(item, index) in list" :key="index">
               <router-link to="/noun"><li @click="getdatab(item.pkId)">
